...
export const SpecificChart = (props: SpecificChartProps): JSX.Element => {
  ...
  if (
    timeseriesRange === TimeseriesRange.THREE_MONTHS &&
...
class SimpleChart extends React.PureComponent<Props> {
  ...
  render() {
    ...
    const contentInset: ContentInsetType = {
      top: 5,
      bottom: 20,
      left: 20,
      right: 20
    ...
    const yAxisWidth = 40;
    const dates = getDatesForDataAndDistribution(
      readings,
      dateOption,
      timeseriesRange,
      strictDateMode
      ...
      >
        ...
        >
          ...
          <LineChart
            ...
            xAccessor={({ item }: { item: AnyOrPendingReading }) =>
          ...
          >
            ...
            <YAxisLabels unitOfMeasure={unitOfMeasure} />
            <HorizontalGrid />
            <DateLabels
              dateOption={dateOption}
              timeseriesRange={timeseriesRange}
            ...
            return (
              <LineChart
                ...
                svg={{
                  ...
                  strokeOpacity: strokeOpacityForIndex(
                    idx,
                    chunkedReadings.length
                  ),
                  strokeWidth: 3
                }}
                contentInset={contentInset}
