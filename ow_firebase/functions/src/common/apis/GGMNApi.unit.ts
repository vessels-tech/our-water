...
describe('GGMNApi', function () {
  ...
  describe('pendingReadingToCSV', function() {
    it('converts a pending reading list to a csv file', async () => {
      ...
      //Assert
      const expected = 
`2017-01-01T00:00:00Z,GWmMSL,00.00,12345
2017-01-01T00:00:00Z,GWmBGS,00.00,12345
2017-01-01T00:00:00Z,GWmMSL,00.00,12346
2017-01-01T00:00:00Z,GWmBGS,00.00,12346
2017-01-01T00:00:00Z,GWmMSL,00.00,12347
2017-01-01T00:00:00Z,GWmBGS,00.00,12347
`;
