...
describe('Public endpoint integration tests', function () {
  ...
  describe('Download Reading Images', function () {
    ...
    this.beforeAll(async () => {
      ...
      await readingApi.readingCol().doc("image_reading_001").set({ ...DefaultReading, id: 'reading_001', resourceId: "00001", timeseriesId: 'default', image: {base64Image} })
      await readingApi.readingCol().doc("image_reading_002").set({ ...DefaultReading, id: 'reading_002', resourceId: "00001", timeseriesId: 'timeseries_2', image: {base64Image} })
