...
const XmlBuilder_1 = require("../../fn_sos/XmlBuilder");
/**
 *
...
class SOSApi {
    ...
    static getCapabilities() {
        console.log(XmlBuilder_1.testTsx());
        return "";
